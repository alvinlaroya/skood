            ...
            <v-toolbar color="cyan" dark flat>
              ...
              <template v-slot:extension>
                <v-tabs v-model="tab" align-with-title>
                  ...
                  <v-tab> Menu details </v-tab>
                  <v-tab>
                    <v-badge
                      color="pink"
                      size="40"
                      :content="menu_request.length"
                      :value="menu_request.length > 0 ? true : false"
                    >
                      Menu Requests
                    </v-badge>
                  </v-tab>
                              ...
                              <v-row>
                                <v-col cols="12" lg="12">
                                  ...
                                  >
                                    Restaurant: </span
                                  ><br />
                                  <span v-for="(resto, i) in restaurants" :key="i">
...
/* import Tab1 from '../../components/menu_tabs/modify_menu'; */
import Tab2 from "../../components/menu_tabs/menu_request";
...
export default {
  ...
  firestore: {
    ...
    menu_request: db.collection("items"),
  },
  methods: {
    selectedMenu(item) {
  ...
  created() {
    this.$bind("menu_request",
      db.collection("items").where("itemStatus", "==", 2)
    );
  },
};
</script>
