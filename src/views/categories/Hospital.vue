         ...
         <v-row>
            ...
            >
                ...
                >
                    ...
                    >
                        <v-icon style="font-size: 70px;" color="white">mdi-hospital</v-icon>
                    </v-sheet>
                    <v-card-text class="pt-0">
                    <div class="title font-weight-light mb-2" style="position: absolute; top: 20px; right: 20px">Hospital</div>
